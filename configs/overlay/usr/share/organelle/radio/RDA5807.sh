...
#
# update oct 27
# RDA5807 or TEA5767 receiver code
# tiny and $.42, 3.3v I2C interface
# this changes the reception freq and thats it
#
#####################################################
# usage:
...
i2cset -y 0 $addr $byte1 $byte2 $byte3 $byte4 $byte5 i
